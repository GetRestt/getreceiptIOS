...
class HomePending extends StatefulWidget {
  const HomePending({Key? key}) : super(key: key);
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<HomePending> with TickerProviderStateMixin{
...
/*    MainService _fromRetrieveData = Provider.of<MainService>(context, listen: false);
    ...
    MainService _pendingReceiptList = Provider.of<MainService>(context, listen: false);
    UserInfoService _userInfoService = Provider.of<UserInfoService>(context, listen: false);
    _userInfo =  _userInfoService.getUserInfo();
    data =_pendingReceiptList.getPendingReceiptData();
